...
// Clerk configuration
export const clerkWebhookSecret: string = process.env.CLERK_WEBHOOK_SECRET || '';
export const clerkPublishableKey: string = process.env.CLERK_PUBLISHABLE_KEY || '';
export const clerkSecretKey: string = process.env.CLERK_SECRET_KEY || '';
